package com.practice.begin.springboot.web;

import com.practice.begin.springboot.service.posts.PostsService;
...
public class PostsApiController {
    ...
    public PostsResponseDto findBId(@PathVariable Long id){
